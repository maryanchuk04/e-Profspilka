...
using EProfispilka.Application.Configurations;
using EProfispilka.Application.Factories;
using EProfispilka.Application.Services;
...
public static class ServicesExtensions
{
    public static void ConfigureServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // Add AutoMapper
        services.AddAutoMapper(typeof(EventsMapper));
