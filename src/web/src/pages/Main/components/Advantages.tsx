...
import { selectAdvantages } from '../../../lib/features/advantages.slice';
...
const Advantages = () => {
    ...
    const moreAdvantages = () => {
        if (count === smCount) setCount(advantages?.length);
                    ...
                    <Container>
                        ...
                        <div className='relative flex flex-wrap gap-12 w-full justify-between my-10 z-20'>
                            {isSmMedia
                                ? advantages
                                      .slice(count)
                                      .map((item) => <AdvantagesCard key={item.id} advantages={item} />)
                                : advantages.map((item) => (
