...
const DiscountsList = ({ status }) => {
    ...
    const renderDiscountCards = () => {
        if (status === MemberStatus.NotVerified) {
            return (
                <div className='text-xs bg-red-400 text-white p-4 rounded-standard my-4 flex items-center'>
    ...
    return (
        <div className='w-full flex flex-col'>
            ...
            <div className='lg:bg-[#E6E6E6] max-md:py-0 mt-2 max-md:px-0 px-12 max-md:w-full w-full py-8 rounded-standard max-h-[900px] overflow-y-auto max-sm:max-h-[300px] xl:h-full'>
