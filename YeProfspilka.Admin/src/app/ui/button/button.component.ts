...
export class ButtonComponent implements OnInit {
	...
	styles(): string {
		if (this.type === 'secondary')
			return 'text-black w-fit duration-300 px-4 bg-transparent border-black border rounded-standart text-xl h-12 font-regular enabled:hover:bg-black/10 w-fit'
